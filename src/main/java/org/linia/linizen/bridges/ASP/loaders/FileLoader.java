package org.linia.linizen.bridges.ASP.loaders;
...
public class FileLoader implements SlimeLoader {
    ...
    public FileLoader(File worldDir) throws IllegalStateException {
        ...
        if (worldDir.exists() && !worldDir.isDirectory()) {
            Debug.echoError("A file named " + worldDir.getName() + " has been deleted, as this is the name used for the worlds directory.");
            if (!worldDir.delete()) {
